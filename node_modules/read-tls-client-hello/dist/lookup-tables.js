...
exports.CERTIFICATE_STATUS_TYPES = exports.CERTIFICATE_COMPRESSION_ALGORITHMS = exports.PSK_KEY_EXCHANGE_MODES = exports.COMPRESSION_METHODS = exports.EC_POINT_FORMATS = exports.SIGNATURE_ALGORITHMS = exports.SUPPORTED_GROUPS = exports.EXTENSION_IDS = exports.EXTENSIONS = exports.CIPHER_SUITES = exports.TLS_VERSIONS = void 0;
function lookupTable(table) {
    return table;
}
exports.TLS_VERSIONS = lookupTable({
    0x0300: 'SSL 3.0',
    0x0301: 'TLS 1.0',
    0x0302: 'TLS 1.1',
    0x0303: 'TLS 1.2',
...
exports.CIPHER_SUITES = lookupTable({
...
exports.EXTENSION_IDS = Object.assign(Object.fromEntries(Object.entries(_extensions).map(([id, name]) => [name, Number(id)])), _extensionAliases);
// https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml#tls-parameters-8
exports.SUPPORTED_GROUPS = lookupTable({
    1: 'sect163k1',
    2: 'sect163r1',
    3: 'sect163r2',
    4: 'sect193r1',
...
exports.SIGNATURE_ALGORITHMS = lookupTable({
...
exports.EC_POINT_FORMATS = lookupTable({
    0: 'uncompressed',
    1: 'ansiX962_compressed_prime',
    2: 'ansiX962_compressed_char2',
});
// https://www.iana.org/assignments/comp-meth-ids/comp-meth-ids.xhtml
exports.COMPRESSION_METHODS = lookupTable({
    0: 'null',
    1: 'DEFLATE',
});
// RFC 8446 section 4.2.9
exports.PSK_KEY_EXCHANGE_MODES = lookupTable({
    0: 'psk_ke',
    1: 'psk_dhe_ke',
});
// https://www.iana.org/assignments/tls-certificate-compression/tls-certificate-compression.xhtml
exports.CERTIFICATE_COMPRESSION_ALGORITHMS = lookupTable({
    1: 'zlib',
    2: 'brotli',
    3: 'zstd',
});
// RFC 6066 / RFC 6961
exports.CERTIFICATE_STATUS_TYPES = lookupTable({
    1: 'ocsp',
    2: 'ocsp_multi',
});
//# sourceMappingURL=lookup-tables.js.map